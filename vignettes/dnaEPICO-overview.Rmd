...
- Inputs: phenotype metadata, IDAT files, array annotation, and filtering
  settings.
- Processing tasks: import, quality control, normalisation, probe
...
- Outputs: model objects, summary tables, diagnostic figures,
...
- Processing tasks: longitudinal model preparation, CpG-LME model
  ...
  annotation.
- Outputs: mixed-model objects, interaction summaries, diagnostic figures,
