...
functions roles. It complements the local-use and pipeline vignettes
...
the structure to collaborators. For detailed arguments and executable
...
The `dnaEPICO` package is organised around function with clear roles.
