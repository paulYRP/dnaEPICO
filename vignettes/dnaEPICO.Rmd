...
-   `outputRDataMerge`: directory for merged phenotypeâ€“methylation objects.
...
This step produces analysis-ready phenotypeâ€“methylation objects for GLM and LME modelling and creates files compatible with the DNAmAge Clock Foundation platform.
...
1.  Loads a merged phenotypeâ€“beta object from `inputPheno`.
...
-   `inputPheno`: merged phenotypeâ€“beta `.RData` input.
...
-   `f3`: Steps 1â€“3 (preprocessing + SVA + merge)
-   `f4`: Steps 1â€“4 (adds GLM)
-   `f3lme`: Steps 1â€“3 and 5 (adds LME4)
-   `all`: Steps 1â€“5
...
-   Run steps 1â€“3 for one model
    -   make f3 MODEL=model1
-   Run steps 1â€“4 for one model
    -   make f4 MODEL=model1
-   Run steps 1â€“3 and 5 for one model
    -   make f3lme MODEL=model1
-   Run the full pipeline
    -   make all MODEL=model1
-   Run multiple models
    -   make models *(run the entire pipeline for all models in parallel.)*
    -   make f3_models *(run Steps 1â€“3 in parallel for all models.)*
    -   make f4_models *(run Steps 1â€“4 in parallel for all models.)*
    -   make f3lme_models *(run Steps 1â€“3 + LME in parallel for all models.)*
