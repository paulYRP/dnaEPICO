...
``` make
â”œâ”€â”€ data/                                   # Processed data outputs (per model)
...
â”‚   â”‚   â”œâ”€â”€ pheno.csv                       # Phenotype file with sample metadata
â”‚   â”‚   â””â”€â”€ 12864_2024_10027_MOESM8_ESM.csv # Cross-reactivity comparison reference
â”‚   â”œâ”€â”€ model1/                             # Outputs specific to the first model
â”‚   â”‚   â”œâ”€â”€ preprocessingMinfiEwasWater/    # Preprocessed phenotype + QC from Minfi
â”‚   â”‚   â”œâ”€â”€ svaEnmix/                       # Surrogate variable analysis 
â”‚   â”‚   â”œâ”€â”€ preprocessingPheno/             # Cleaned and merged phenotype files 
â”‚   â”‚   â”œâ”€â”€ methylationGLM_T1/              # CpG-level GLM results (single timepoint)
â”‚   â”‚   â”œâ”€â”€ methylationGLMM_T1T2/           # Longitudinal LME results (T1 vs T2)
â”‚   â”‚   â””â”€â”€ ...                             # Additional subfolders by model
â”‚   â”œâ”€â”€ model2/
â”‚   â””â”€â”€ model3/
...
â”œâ”€â”€ results/                                # Output tables and summary statistics
â”œâ”€â”€ reports/                                # Rendered reports (PDF)
```
...
4.  Optionally writes summary outputs, plots, and updated objects when `saveOutputs = TRUE`.
...
5.  Optionally writes cleaned phenotype tables to `outputPheno`, metric objects to `outputRData`, and merged objects to `outputRDataMerge` when `saveOutputs = TRUE`.
...
`dnamReport()` generates a PDF report by rendering `DNAm.Rmd` through a
runner script (`DNAm.R`) shipped in `inst/scripts`.
...
- If a step â€œfailsâ€, check logs in `logs/`
...
To avoid creating permanent files on the userâ€™s computer, **all steps are run inside a temporary directory**.
...
We now copy these IDAT files into the directory structure expected by S`dnaEPICO`.
