...
optional variable, path, mapping, or model term should be absent. `CHUNK_SIZE`
uses `NULL` for automatic chunking because it disables a user-specified tuning
value rather than applying a filter.
