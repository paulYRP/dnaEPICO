# Getting help with `dnaEPICO`

Thank you for using `dnaEPICO`!
...
* Bioconductor software related questions, such as bug reports and feature
  requests, should be addressed in the appropriate `Bioconductor/dnaEPICO`
...
* Bioconductor software usage questions should be addressed in the
  ...
  to use the
  [appropriate package tag](https://support.bioconductor.org/tag/dnaEPICO),
...
[search issues and pull requests](https://github.com/paulYRP/dnapipeR/issues)
