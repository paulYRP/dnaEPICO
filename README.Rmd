...
Install a current `R` release from [CRAN](https://cran.r-project.org/), then install the development version of `dnaEPICO` from GitHub:
...
The `dnaEPICO` project follows the [Bioconductor Code of Conduct](https://bioconductor.org/about/code-of-conduct/). Contributors agree to follow its terms.

## Development tools

* [GitHub Actions](https://github.com/paulYRP/dnaEPICO/actions) runs package checks with Bioconductor containers and `r BiocStyle::Biocpkg('BiocCheck')`.
* [Codecov](https://codecov.io/gh/paulYRP/dnaEPICO) and `r BiocStyle::CRANpkg('covr')` report code coverage.
* `r BiocStyle::CRANpkg('pkgdown')` builds the [documentation website](https://paulYRP.github.io/dnaEPICO).
* `r BiocStyle::CRANpkg('styler')` formats R code.
* `r BiocStyle::CRANpkg('devtools')` and `r BiocStyle::CRANpkg('roxygen2')` generate package documentation.
